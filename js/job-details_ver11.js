...
function CreateHTMLPopup_new(ComName, IsBangla, JobNo) {
    ...
    strJobDetailsPopUp1 += "				<button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;<\/button>";
    strJobDetailsPopUp1 += "				<h4 class=\"modal-title\"><span class=\"bn\" style=\" font-weight: bold;\">সতর্কবার্তা<\/span><span class=\"en\">Warning Message<\/span>";
    strJobDetailsPopUp1 += "				<\/h4>";
    strJobDetailsPopUp1 += "			<\/div>";
    strJobDetailsPopUp1 += "			<div class=\"modal-body\">";
    strJobDetailsPopUp1 += "				<p style=\"margin-bottom: 20px;\"><span class=\"bn bnmenu\" style=\"font-size: 18px;\">বিডিজবস শুধুমাত্রই নিয়োগকর্তা এবং চাকরিপ্রার্থীদের মাঝে যোগাযোগ মাধ্যম";
    ...
    strJobDetailsPopUp1 += "						দায়ী থাকবে না। <\/span><span class=\"en\" style=\"font-size: 16px !important;\">Bdjobs.com only works as a mean of communication between employers and job-seekers.";
    ...
    strJobDetailsPopUp1 += "					<label><input type=\"checkbox\" style=\"\" id =\"chkApplybtn\" value=\"\"><span class=\"bn\" style=\"font-size: 18px;\" >উপরোক্ত সতর্ক বার্তাটি আমি পড়েছি ";
    strJobDetailsPopUp1 += "							<\/span><span class=\"en\" style=\"font-size: 16px !important;\" >I have read the above warning message.";
    strJobDetailsPopUp1 += "							<\/span><\/label>";
    strJobDetailsPopUp1 += "				<\/div>";
    strJobDetailsPopUp1 += "				<div class=\"apply-btn text-center\" style=\"margin-top: 25px;\">";
    strJobDetailsPopUp1 += "					<button class=\"btn acptCondition disabled\" data-dismiss=\"modal\" onclick = \"formSubmit()\"><span class=\"bn\">আবেদন<\/span><span";
